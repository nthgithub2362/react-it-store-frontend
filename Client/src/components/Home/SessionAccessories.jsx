...
class SessionAccessories extends Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ProductService.getlistACE().then((res) => {
  ...
  render() {
    {
      ...
      return (
        <section className="padding-bottom-sm"  style={{ backgroundColor: "#fff"}}>
          ...
          <i class="fas fa-headphones"></i> Phụ kiện nổi bật nhất
          </h2>
                ...
                {this.state.accessories.map((phone) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <a
                        type="button"
                        href={'http://localhost:3000/products/accessories/detail-product/'+phone.id}
                        className="img-wrap"
                      >
                        <img
                          width="100%"
                          style={{ padding: "10px" }}
                          src={"images/product/" + phone.image}
                        />
                      </a>
                      <a
                        type="button"
                      ...
                      >
                        ...
                        {(() => {
                          ...
                          <a href={'http://localhost:3000/products/accessories/detail-product/'+phone.id}>{phone.name}</a>
                       <br/>
                        {(()=>{
...
export default SessionAccessories;
