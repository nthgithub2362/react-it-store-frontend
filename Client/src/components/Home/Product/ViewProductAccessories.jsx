...
class ViewProductAccessories extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  componentDidMount() {
    ...
    NewService.getListNewPhones().then((res) => {
              ...
              <main className="col-md-6">
                ...
                <h2 className="title mt-3">{this.state.product.name} </h2>
                  ...
                  <div className="col-md-12">
                    <img
                      width="80%"
                      src="http://localhost:3000/images/800-200-800x200-119.png"
                    />
                  </div>
                  {/* rating-wrap.// */}
                  <div className="mb-3">
        ...
        >
         ...
         {ReactHtmlParser(this.state.review.description_review)}
              ...
              <div className="col-md-4">
                ...
                <h5 className="title-description">Tin tức về điện thoại</h5>
...
export default ViewProductAccessories;
