...
class ProductFilter extends Component {
  ...
  componentDidMount() {
    ...
    if( brand=='vivo')
    {
      localStorage.setItem('brand', "Vivo");
    }
    if( brand=='iphone')
    {
      localStorage.setItem('brand', "iPhone");
    }
    if( brand=='oppo')
    {
    ...
    if( brand=='realme')
    {
      localStorage.setItem('brand', "Realme");
    }
    
    if( price_large==2000000)
    {
      localStorage.setItem('price_large',"Dưới 2 triệu");
    }
    if( price_large==4000000)
    {
      localStorage.setItem('price_large',"Từ 2-4 triệu");
    }
    if( price_large==7000000)
    {
      localStorage.setItem('price_large',"Từ 4-7 triệu");
    }
    if( price_large==13000000)
    {
      localStorage.setItem('price_large',"Từ 7-13 triệu");
    }
    if( price_small==20000000)
    {
      localStorage.setItem('price_large',"Trên 20 triệu");
    }
    
   
    console.log(brand);
    ProductService.getFilter(price_small,price_large,brand).then((res) =>
