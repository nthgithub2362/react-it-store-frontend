...
class ProductAccessories extends Component {
    constructor(props) {
      ...
      componentDidMount() {
        ...
        SliderService.getSiderAcess().then((res) => {
          this.setState({ slider: res.data });
        });
        LogoService.getLogoAc().then((res) => {
    ...
    <div className="row">
        ...
        <div className="col-md-2" style={{marginTop:'20px'}}>
            <a  className="nav-link alogo" href={"http://localhost:3000/product/accessories/"+logo.title}>
              <img
                width="70%"
                    ...
                    >
                      ...
                      >
                        <img
                          width="100%"
                          style={{ padding: "10px" }}
                          src={"http://localhost:8080/images/product/" + phone.image}
                        />
                      </a>
                      <a
                        type="button"
