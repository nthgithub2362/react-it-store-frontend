...
class SessionItemLap extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    {
      ...
      return (
        <section className="padding-bottom-sm"  style={{ backgroundColor: "#fff"}}>
          ...
          <i class="fas fa-laptop"></i> Laptop nổi bật nhất
          </h2>
                    ...
                    >
                      ...
                      >
                        ...
                        {(() => {
                          ...
                          <a href={'http://localhost:3000/products/laptop/detail-product/'+phone.id}>{phone.name}</a>
                       <br/>
                        {(()=>{
